...
class plotter:
    def __init__(self, test, test_3, results, results_2, results_3, results_4, fignum):
        ...
        self.v = v = list(results.values())
        self.v_2 = v_2 = list(results_2.values())
        #print v
        ...
        self.mins_x = numpy.array(range(len(v)))
        ...
        self.v = v = list(results_3.values())
        self.v_2 = v_2 = list(results_4.values())
        #print v
    ...
    def plot_blocks(self, data):
        nblocks = data[6]
        block_dict = data[7]
        self.blks_x = numpy.array(range(nblocks))

        sorted_dict = sorted(iter(block_dict.items()), key=operator.itemgetter(0))
        sorted_dict.reverse()
