...
exec(compile(open("/home/zivkovic/.grc_gnuradio/tigr_ber_measurement.py", "rb").read(), "/home/zivkovic/.grc_gnuradio/tigr_ber_measurement.py", 'exec'))
exec(compile(open("/home/zivkovic/.grc_gnuradio/tigr_fbmc_inner_receiver.py", "rb").read(), "/home/zivkovic/.grc_gnuradio/tigr_fbmc_inner_receiver.py", 'exec'))
exec(compile(open("/home/zivkovic/.grc_gnuradio/tigr_fbmc_snr_estimator.py", "rb").read(), "/home/zivkovic/.grc_gnuradio/tigr_fbmc_snr_estimator.py", 'exec'))
exec(compile(open("/home/zivkovic/.grc_gnuradio/tigr_scatterplot.py", "rb").read(), "/home/zivkovic/.grc_gnuradio/tigr_scatterplot.py", 'exec'))
exec(compile(open("/home/zivkovic/.grc_gnuradio/tigr_transmit_control.py", "rb").read(), "/home/zivkovic/.grc_gnuradio/tigr_transmit_control.py", 'exec'))
